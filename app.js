...
// STORAGE KEYS (V6_CLEAN HARD PURGE)
const USERS_DB_KEY = 'STORE_USERS_DB_V6_CLEAN';
const REQUESTS_DB_KEY = 'STORE_REQUESTS_DB_V6_CLEAN';
const CHAT_DB_KEY = 'STORE_CHAT_DB_V6_CLEAN';
const CHAT_ROOM_DB_KEY = 'STORE_CHAT_ROOM_DB_V6_CLEAN';
const TTD_DB_KEY = 'STORE_TTD_DB_V6_CLEAN';
const SESSION_KEY = 'STORE_ACTIVE_SESSION_V6_CLEAN';
const THEME_KEY = 'STORE_ACTIVE_THEME_V6_CLEAN';
const STORES_DB_KEY = 'STORE_CUSTOM_TOKO_LIST_V6_CLEAN';
const DELETED_STORES_KEY = 'STORE_DELETED_TOKO_LIST_V6_CLEAN';
const NOTIFICATIONS_DB_KEY = 'STORE_SYSTEM_NOTIFICATIONS_V6_CLEAN';
const KODE_UNIT_MAP_KEY = 'STORE_KODE_UNIT_MAP_V6_CLEAN';
const FEATURE_PHOTOS_KEY = 'STORE_FEATURE_PHOTOS_V6_CLEAN';
const DELETED_REQUESTS_KEY = 'STORE_DELETED_REQUESTS_V6_CLEAN';
const DELETED_USERS_KEY = 'STORE_DELETED_USERS_V6_CLEAN';
...
const KODE_UNIT_MAP = {
  'AC09': 'AC-09V4-INV (1 PK INVERTER)',
  'AC05': 'AC-05V4-STD (0.5 PK STANDARD)',
  'TV50': 'TV-50X8000-LED 4K SMART',
  'TV43': 'TV-43X7000-LED FULL HD',
  'REF2': 'REF-2D-210L (KULKAS 2 PINTU)',
  'WASH': 'WM-FL-8500 (MESIN CUCI FRONT LOAD)',
  'SNBD': 'AC-09V4-INV (AIR CONDITIONER)',
